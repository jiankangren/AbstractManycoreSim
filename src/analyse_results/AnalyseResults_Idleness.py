...
w_idleness_results = plot_WindowedIdleness(fname="../test__util.js")
ibuff_usage_results = plot_InputBuff_Usage(fname="../test__ibuff.js")
...
plot_NodeTQ_Usage('tq_len', report_summary=True, pfname = "../test__nodetqs.js")
plot_NodeTQ_Usage('cum_lateness', report_summary=True, pfname = "../test__nodetqs.js")
