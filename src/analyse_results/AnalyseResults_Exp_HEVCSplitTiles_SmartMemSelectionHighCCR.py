...
DATA_TEMP_SAVE_LOC = "../experiment_data/hevc_tile_mapping_wMemPSel_HighCCR/"
...
global_types_of_tests = [
                    ...
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':2, 'lbl': "CL-BG_MMPLM"},
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':3, 'lbl': "CL-BG_MMPLUDist"},
                    #{'mp':0, 'pr':0, 'cmb':914 , 'mmp':4, 'lbl': "CL-BG_MMPRand"},
                    #{'mp':0, 'pr':0, 'cmb':914 , 'mmp':5, 'lbl': "CL-BG_MMPIdeal"},
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':30, 'lbl': "CL-BG_MMPLUFF"},
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':31, 'lbl': "CL-BG_MMPLMFF"},
                    #{'mp':0, 'pr':0, 'cmb':914 , 'mmp':32, 'lbl': "CL-BG_MMPIdealFF"},
                    #{'mp':0, 'pr':0, 'cmb':914 , 'mmp':33, 'lbl': "CL-BG_MMPLU-CI-FF"},
                    #{'mp':0, 'pr':0, 'cmb':914 , 'mmp':34, 'lbl': "CL-BG_MMPLM-CI-FF"},
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':36, 'lbl': "CL-BG_MMPLM-LB-P"},
                    {'mp':0, 'pr':0, 'cmb':914 , 'mmp':37, 'lbl': "CL-BG_MMPLMRandFF"},
                    

                    # 911 (CL-IPB)
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':0, 'lbl': "CL-IPB_MMPDist"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':1, 'lbl': "CL-IPB_MMPLU"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':2, 'lbl': "CL-IPB_MMPLM"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':3, 'lbl': "CL-IPB_MMPLUDist"},
                    #{'mp':0, 'pr':0, 'cmb':911 , 'mmp':4, 'lbl': "CL-IPB_MMPRand"},
                    #{'mp':0, 'pr':0, 'cmb':911 , 'mmp':5, 'lbl': "CL-IPB_MMPIdeal"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':30, 'lbl': "CL-IPB_MMPLUFF"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':31, 'lbl': "CL-IPB_MMPLMFF"},
                    #{'mp':0, 'pr':0, 'cmb':911 , 'mmp':32, 'lbl': "CL-IPB_MMPIdealFF"},
                    #{'mp':0, 'pr':0, 'cmb':911 , 'mmp':33, 'lbl': "CL-IPB_MMPLU-CI-FF"},
                    #{'mp':0, 'pr':0, 'cmb':911 , 'mmp':34, 'lbl': "CL-IPB_MMPLM-CI-FF"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':36, 'lbl': "CL-IPB_MMPLM-LB-P"},
                    {'mp':0, 'pr':0, 'cmb':911 , 'mmp':37, 'lbl': "CL-IPB_MMPLMRandFF"},



                    # 912 (PP)
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':0, 'lbl': "PP_MMPDist"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':1, 'lbl': "PP_MMPLU"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':2, 'lbl': "PP_MMPLM"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':3, 'lbl': "PP_MMPLUDist"},
                    #{'mp':0, 'pr':0, 'cmb':912 , 'mmp':4, 'lbl': "PP_MMPRand"},
                    #{'mp':0, 'pr':0, 'cmb':912 , 'mmp':5, 'lbl': "PP_MMPIdeal"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':30, 'lbl': "PP_MMPLUFF"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':31, 'lbl': "PP_MMPLMFF"},
                    #{'mp':0, 'pr':0, 'cmb':912 , 'mmp':32, 'lbl': "PP_MMPIdealFF"},
                    #{'mp':0, 'pr':0, 'cmb':912 , 'mmp':33, 'lbl': "PP_MMPLU-CI-FF"},
                    #{'mp':0, 'pr':0, 'cmb':912 , 'mmp':34, 'lbl': "PP_MMPLM-CI-FF"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':36, 'lbl': "PP_MMPLM-LB-P"},
                    {'mp':0, 'pr':0, 'cmb':912 , 'mmp':37, 'lbl': "PP_MMPLMRandFF"},


                    # 903 (LU)
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':0, 'lbl': "LU_MMPDist"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':1, 'lbl': "LU_MMPLU"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':2, 'lbl': "LU_MMPLM"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':3, 'lbl': "LU_MMPLUDist"},
                    #{'mp':0, 'pr':0, 'cmb':903 , 'mmp':4, 'lbl': "LU_MMPRand"},
                    #{'mp':0, 'pr':0, 'cmb':903 , 'mmp':5, 'lbl': "LU_MMPIdeal"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':30, 'lbl': "LU_MMPLUFF"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':31, 'lbl': "LU_MMPLMFF"},
                    #{'mp':0, 'pr':0, 'cmb':903 , 'mmp':32, 'lbl': "LU_MMPIdealFF"},
                    #{'mp':0, 'pr':0, 'cmb':903 , 'mmp':33, 'lbl': "LU_MMPLU-CI-FF"},
                    #{'mp':0, 'pr':0, 'cmb':903 , 'mmp':34, 'lbl': "LU_MMPLM-CI-FF"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':36, 'lbl': "LU_MMPLM-LB-P"},
                    {'mp':0, 'pr':0, 'cmb':903 , 'mmp':37, 'lbl': "LU_MMPLMRandFF"},
...
#fixed_global_colors = [c for c in  colors_for_cluster_mp + colors_for_lu_mp]

# tmp_global_colors = plt.get_cmap('Blues')(np.linspace(0, 1.0, 2))   +\
#                     plt.get_cmap('Reds')(np.linspace(0, 1.0, 2)) +\
#                     plt.get_cmap('Greens')(np.linspace(0, 1.0, 2))
#global_colors = fixed_global_colors

#global_colors = ['red']*1 + ['blue']*1 + ['green']*1 +['yellow']*1
...
#global_colors = [temp_global_colors[0]]*3 + [temp_global_colors[1]]*3 + [temp_global_colors[2]]*3 + [temp_global_colors[3]]*3
global_colors = [temp_global_colors[0]]*num_mmc_types + \
                [temp_global_colors[1]]*num_mmc_types + \
                [temp_global_colors[2]]*num_mmc_types + \
                [temp_global_colors[3]]*num_mmc_types

print global_colors
#sys.exit()

global_hatch_patterns = ['-', '+', 'x', '\\', '*', 'o', 'O', '.']
...
def boxplot_colorize(bp, param_col, fc='#B8DCE6'):    
    ...
    for box in bp['boxes']:
        ...
        box.set( color='#000000', linewidth=1.2)
        # change fill color
    ...
    for whisker in bp['whiskers']:
        whisker.set(color='#000000', linewidth=1.2, linestyle='-')
    ...
    for median in bp['medians']:
        median.set(color='#000000', linewidth=1.2)
    
    ## change the style of fliers and their fill
    for flier in bp['fliers']:
        flier.set(marker='x', color='red', alpha=0.8)
...
def plot_MappingExecOverhead(load_data=False):
    ...
    for num, each_exp in enumerate(global_mp_order):            
        ...
        #print ydata
        extra_padding = int(num/global_num_mmptypes) * 0.1            
        xdata = (ind*2) +(width*num) + extra_padding
        #xdata = ind+(width*num)
...
#             plt.scatter([scatter_x]*len(scatter_y), scatter_y, marker='x', color='r', zorder=100)
        ...
        if "_MMPDist" in each_exp:
            rect_lbl_list.append(each_exp.replace("_MMPDist", ""))        
        ...
        ## annotate on top of the boxplots ##
        #all_tops = [np.max(yy)+0.1 for yy in ydata]
        #for ix, top in enumerate(all_tops):
        top = np.max(ydata) + 0.1
        top_txt = each_exp[each_exp.index("_")+1:]
        
#             ax.text(xdata, top, top_txt,
#                              horizontalalignment='center', 
#                              verticalalignment='bottom',
#                              size=14, weight='semibold', rotation=15,
#                              color='k')
        
        x_ticks_lbl.append(top_txt)
        x_tick_pos.append(xdata)    
    ...
    leg = ax.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':14}, loc='upper center', bbox_to_anchor=(0.5, 1.05), fancybox=True, shadow=True)
    
    #leg = plt.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':14})
    leg.draggable(True)
    ...
    ax.set_xticklabels(x_ticks_lbl, fontsize=14, rotation=35, 
...
#                              color='k')
    ...
    leg.draggable()
    ax.tick_params(axis = 'y', which = 'major', labelsize=14)    
    ax.set_ylabel('Cumulative data communication volume (GB)', fontsize=14, multialignment='center')        
    #ax.set_xlabel('Workload configurations', fontsize=14)        
    ax.xaxis.major.formatter._useMathText = True
...
#             plt.scatter([scatter_x]*len(scatter_y), scatter_y, marker='x', color='r', zorder=100)
    ...
    leg = ax.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':13}, loc='upper center', bbox_to_anchor=(0.5, 1.295),
...
#             leg = plt.legend(rects_list, rect_lbl_list,ncol=4)
#             leg.draggable(True)
...
#                              color='k')
        ...
        #leg = ax.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':14}, loc='upper center', bbox_to_anchor=(0.5, 1.295), fancybox=True, shadow=True)
        leg = ax.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':14}, loc='upper center', bbox_to_anchor=(0.5, 1.05), fancybox=True, shadow=True)
        
        #leg = plt.legend(rects_list, rect_lbl_list,ncol=4, prop={'size':14})
        leg.draggable(True)
        ax.tick_params(axis = 'y', which = 'major', labelsize=14)        
        ax.set_ylabel('Job lateness (s)\n(symmetric-log scale)', fontsize=14, multialignment='center')
        #ax.set_ylabel('Job lateness (s)', fontsize=14, multialignment='center')
        #ax.set_xlabel('Workload configurations', fontsize=14)        
        ax.xaxis.major.formatter._useMathText = True
        #ax.set_xlim(-0.13, 2+(width*6))
        #ax.set_ylim(-1.47, 41.4)
        ...
        # workload ticks
        #ax.set_xticks((ind*2)+( ((width*(float(num_exp)/(width*9.23))/2.0)) ) )
        #ax.set_xticklabels(global_workload_configs)
        
        # single workload ticks - mmp types labels
        ax.set_xticks(x_tick_pos)
        ax.set_xticklabels(x_ticks_lbl, fontsize=14, rotation=35, 
                              horizontalalignment='right', 
                              )
        ...
        #plt.yscale('symlog')
        plt.yscale("symlog", linthreshy=0.25)
