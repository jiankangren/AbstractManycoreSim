...
class RunTimeTaskManager_PSAlgo(RunTimeTaskManager_ClosedLoop_wIBuffering):
    ...
    def __init__(self, env, polling_delay, mapping_policy, 
        ...
        self.label = "RunTimeTaskManager_PSAlgo::"
                        ...
                        if(each_task_val.get_releaseTime() == self.env.now):
                            if(each_task_key in self.task_mapping_table):                        
                                ...
                                if(node_to_map != None):
                                    ...
                                    if(isinstance(node_to_map, CPUNode_OpenLoop) == True):
