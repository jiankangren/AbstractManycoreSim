...
###################################################################################################
def runSim_TileMapping_withMemPSel(    
                           forced_seed = None,
                           cmbmppri_type=None,
...
# #     
    ...
    print "cc_scale_down: ", cc_scale_down  
    print "(med ccr range): ", SimParams.CLSTR_TILE_PARAM_BGROUP_CCR_RANGES_MED, SimParams.CLSTR_TILE_PARAM_CCR_RANGES_MED
    print "CL-BG params : ", SimParams.CLSTR_TILE_PARAM_BGROUP_NGT_HOPS    
    print "-------------"
    ...
    if(_check_file_exists(check_fname) == True):        
        ...
        print "----------------------------------------------------------------------------------------------------------------------------"
        print subdir2
        print "Running runSim_TileMapping_withMemPSelHighCCR-"+ fname_prefix  +": num_wf=" + str(SimParams.NUM_WORKFLOWS) + \
...
# construct filename
runSim_TileMapping_withMemPSel(
