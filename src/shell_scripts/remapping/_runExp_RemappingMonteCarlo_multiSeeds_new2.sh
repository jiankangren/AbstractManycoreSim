...
do
	...
	###########################################
	outname="logs/runexp_remappingmc_v2_seed_${seed}.out"

	nohup python -u RunSim_Exp_PSBasedRemapping_MCTest_main.py --forced_seed=$seed --param_gen_seed=6862 &> $outname &
