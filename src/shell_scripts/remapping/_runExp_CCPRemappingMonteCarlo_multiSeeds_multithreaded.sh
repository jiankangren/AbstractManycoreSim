...
#random_seed_array=(43894 70263 42198 94064 68553 95537 18065 64217 6878 \
#                   94986 77379 98652 84400 68385 66093 69923 73337 88117 \
#                   79292 53784)
...
do
	dirname="experiment_data/remapping_ccpbased_montecarlo/seed_${seed}"
	mkdir -p $dirname
done


####### run script #######
outname="logs/runexp_ccpremappingmc.out"
nohup python -u RunSim_Exp_CCPBasedRemapping_MCTest_main_multithreaded.py &> $outname &
