...
{
#CONFIG, CMB, SEED
outname="logs/runexp_hevc_tile_mapping_conf_test_${1}_cmb${2}_mmemp${3}_seed${4}.out"
...
run_simulation $config4 912 0 80505
#run_simulation $config2 911 0 80505
#run_simulation $config3 911 0 80505
