...
random_seed_array=(26358 69541 5558 69433 94064)


# random_seed_array=(81665 33749 43894 53784 80505 83660 22817 70263 29917 \
# 26044 6878 66093 \
# 76891 22250 42198 18065 \
# 74076 98652 21149 50399 64217 \
# 44117 57824 42267 83200 99108 \
# 95928 53864 44289 77379 80521 \
# 88117 23327 73337 31982)
...
do
	...
	for i in {8,12}
	  do
		 ...
		 --wf_num=$i \
		 --forced_seed=$seed \
		 --run_full_fact_schemes=1 \
		 --pri_ass_scheme=888	\
		 --mapping_scheme=888 &> $outname &
