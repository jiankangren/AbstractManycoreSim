...
outname="logs/runexp_hevc_bgmpnhopshighccr_conf_${1}_cmb${2}_mmemp${3}_seed${4}_nhops_h${5}_m${6}_l${7}.out"
...
do
	...
	do
		...
		do	
			...
			do	
				run_simulation $config2 $cmb_type $mpsel_type $seed $nhgt_h $nhgt_m $nhgt_l
			done
		done
	done
done
