...
{
#AC,MP,CMB,PR
outname="logs/runexp_nocsize_noschedtest_ac${1}_mp${2}_cmb${3}_pr${4}_seed${5}.out"
nohup python -u RunSim_Exp_HRTVideo_NoCScale_noSchedTest.py --ac_type=$1 --mp_type=$2 --cmbmppri_type=$3 --pr_type=$4 --forced_seed=$5 &> $outname &
}
