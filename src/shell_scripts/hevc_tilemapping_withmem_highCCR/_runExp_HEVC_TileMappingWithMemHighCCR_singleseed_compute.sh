...
{
#CONFIG, CMB, SEED
outname="logs/runexp_hevc_tile_mapping_highccr_conf_${1}_cmb${2}_mmemp${3}_seed${4}.out"
...
# CL-BG=914, KK=912, LU=903, CL-IPB=911
all_cmb_list=(903 914 912)

# mmcDist=0, mmcLU=1, mmcLM=2, mmcLUDist=3
#all_memp_types=(0 1 2 3 4 5)
#all_memp_types=(30 31 32)
...
do
	...
	do
			...
			do
				#run_simulation $config1 $cmb 0 $seed
