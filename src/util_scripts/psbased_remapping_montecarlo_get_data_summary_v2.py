...
#MAX_SEEDS = len(RANDOM_SEED_LIST)
MAX_SEEDS = 30
...
def construct_summary_data():
    ...
    for k, rand_params in rand_params_dict1.iteritems():        
        ...
        processed_seeds = 0
        for each_seed in RANDOM_SEED_LIST[:MAX_SEEDS]:
            DATA_FOLDER = "Z:/MCASim/experiment_data/remapping_psbased_montecarlo/"+"seed_"+str(each_seed)+"/"
    ...
    fname_summary_output =    "Z:/MCASim/experiment_data/remapping_psbased_montecarlo/" + "mcparam_final_results.js"
    fname_error_output =    "Z:/MCASim/experiment_data/remapping_psbased_montecarlo/" + "mcparam_error_.js"
