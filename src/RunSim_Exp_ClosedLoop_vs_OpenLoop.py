...
EXP_DATADIR = "experiment_data/closedloop_vs_openloop/"



# basic test - openloop
def runSim_Simple_OpenLoop(noc_h, noc_w):
    ...
    SimParams.DYNAMIC_TASK_MAPPING_SCHEME = TaskMappingSchemes.TASKMAPPINGSCHEMES_LOWEST_UTILISATION_NEARESTPARENT
...
def runSim_Simple_ClosedLoop_woIBuffering(noc_h, noc_w):
...
if(args.noc_h == -1) or (args.noc_w == -1):
    ...
    runSim_Simple_OpenLoop(args.noc_h, args.noc_w)
    runSim_Simple_ClosedLoop_woIBuffering(args.noc_h, args.noc_w)
